...
data_test1 = sample(
    "norm1", dist.Normal(10, 1), rng_key=PRNGKey(0), sample_shape=(1000,)
)
data_test2 = sample(
    "norm2", dist.Normal(0, 1), rng_key=PRNGKey(0), sample_shape=(1000,)
)
data_test3 = sample(
    "norm3", dist.Normal(-10, 1), rng_key=PRNGKey(0), sample_shape=(1000,)
)
